...
<div class="drawer absolute">
  ...
  <div class="drawer-side">
    ...
    <div class="bg-base-200 text-base-content min-h-full w-80 lg:w-80 p-4">
      <div class="flex flex-row justify-between">
        ...
        <label for="cart-drawer" aria-label="close sidebar" class="drawer-overlay btn btn-ghost btn-circle right-0">X</label>
      </div>
    </div>
  </div>
</div>
